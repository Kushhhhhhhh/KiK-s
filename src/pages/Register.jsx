...
const Register = () => {
  ...
  const dispatch = useDispatch(); 
    ...
    return (
      <div className="bg-bgColor w-full min-h-screen flex items-center justify-center p-6 ">
        <div className="w-full md:w-2/3 h-fit lg:h-full 2xl:h-5/6 py-8 lg:py-0 flex flex-row-reverse bg-primary rounded-xl overflow-hidden shadow-xl">
          ...
          <div className="w-full lg:w-1/2 h-full p-10 2xl:px-20 flex  flex-col justify-center">
            ...
            <form className='py-4 flex flex-col gap-3' onSubmit={handleSubmit(onSubmit)}>
          ...
          {/* RIGHT */}
          <div className='hidden w-1/2 min-h-auto lg:flex flex-col items-center justify-center bg-blue'>
          ...
          <div className='absolute flex items-center gap-1 bg-white left-10 top-3 py-2 px-5 rounded-full'>
            <ImConnection />
          ...
          <div className='mt-16 text-center'>
            <p className='text-white text-base'>Connect with friends & have KiK's for fun : ) </p>
